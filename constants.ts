...
export const MOCK_ORDERS: Order[] = [
  { id: 'ORD-001', customerName: 'Tata Projects', product: 'TMT Bars', quantity: 5000, priority: 'High', dueDate: '2025-08-15', destination: 'Mumbai', status: 'Pending', assignedManagerId: 2 },
  { id: 'ORD-002', customerName: 'L&T Construction', product: 'Steel Plates', quantity: 12000, priority: 'High', dueDate: '2025-08-20', destination: 'Chennai', status: 'Pending', assignedManagerId: 3 },
  ...
  { id: 'ORD-006', customerName: 'Patna CMO Stockyard', product: 'Hot Rolled Coils', quantity: 7000, priority: 'High', dueDate: '2025-08-18', destination: 'Patna Stockyard', status: 'Pending', assignedManagerId: 4 },
  { id: 'ORD-007', customerName: 'Kolkata CMO Stockyard', product: 'Cold Rolled Coils', quantity: 10000, priority: 'Medium', dueDate: '2025-08-28', destination: 'Kolkata Stockyard', status: 'Pending', assignedManagerId: 4 },
  { id: 'ORD-008', customerName: 'Delhi Metro Rail', product: 'Galvanized Steel', quantity: 4000, priority: 'High', dueDate: '2025-08-22', destination: 'Delhi', status: 'Pending' },
];
